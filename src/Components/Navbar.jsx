//17240b05eff045ea9e2731e053c2e764
function Navbar({setCategory}) {
    return(
        
<nav className="navbar navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
  <div className="container-fluid">
    <a className="navbar-brand" href="#"><span className="badge bg-danger text-light fs-4">BBC</span> <span className="badge bg-light text-dark fs-4">News</span></a>
